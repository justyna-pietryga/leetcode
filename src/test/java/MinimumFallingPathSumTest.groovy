...
class MinimumFallingPathSumTest extends Specification {
    def underTest = new MinimumFallingPathSum()

    def "minimum falling path counted properly"() {
        when:
        def result = underTest.minFallingPathSum(input as int[][])
        ...
        [[2, 1, 3], [6, 5, 4], [7, 9, 9]] | 13
        [[2, 1, 3], [6, 6, 5], [7, 9, 9]] | 14
        [[-19, 57], [-40, -5]]            | -59
        [[51, 24], [-50, 82]]             | -26
